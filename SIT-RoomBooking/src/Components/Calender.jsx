...
const Calendar = () => {
  ...
  const [selectedDate, setSelectedDate] = useState(null); // เก็บ { day, month, year, index }
  ...
  // สร้างอาเรย์วันที่ (รวมวันจากเดือนก่อนหน้า)
  const days = [
  ...
  return (
    <div className="max-w-sm  bg-white p-4 rounded-lg shadow">
      ...
      <div className="grid grid-cols-7 text-center">
        {days.map((day, i) => {
          const isSelected = selectedDate && selectedDate.index === i;
          ...
          return (
            <div
              ...
              onClick={() =>
                day && setSelectedDate({ day, month: selectedMonth, year: selectedYear, index: i })
              }
            >
              {day || ""}
            </div>
